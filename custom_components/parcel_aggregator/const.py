...
KNOWN_CARRIERS: dict[str, str] = {
    ...
    "slovak_parcel_service": "Slovak Parcel Service",
    "slovenska_posta": "Slovenská Pošta",
    "sunyou": "SunYou",
...
CARRIER_EVENT_PREFIXES: dict[str, str] = {
    ...
    "slovak_parcel_service": "slovak_parcel_service",
